...
CREATE POLICY "photos users delete own" ON "storage"."objects" FOR DELETE TO "authenticated" USING ((("bucket_id" = 'photos'::"text") AND ("owner_id" = ( SELECT ("auth"."uid"())::"text" AS "uid"))));



CREATE POLICY "photos users insert own" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'photos'::"text") AND (("storage"."foldername"("name"))[1] = ( SELECT ("auth"."uid"())::"text" AS "uid"))));



CREATE POLICY "photos users update own" ON "storage"."objects" FOR UPDATE TO "authenticated" USING ((("bucket_id" = 'photos'::"text") AND ("owner_id" = ( SELECT ("auth"."uid"())::"text" AS "uid")))) WITH CHECK ((("bucket_id" = 'photos'::"text") AND ("owner_id" = ( SELECT ("auth"."uid"())::"text" AS "uid"))));
